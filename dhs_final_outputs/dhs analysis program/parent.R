...
wi_file_list <- list()
pr_file_list <- list()
chmort_file_list <- vector("list", length(countries))
chmort_res_list <- vector('list',length(countries))
wealth_res_list <- vector('list',length(countries))
...
wealth_file_list <- vector("list",length(countries))
gini_res_list <- vector("list",length(countries))
gini_results_file_list <- vector('list',length(countries))
...
combine_file_list <- vector('list',length(countries))
