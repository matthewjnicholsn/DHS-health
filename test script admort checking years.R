##Nigeria 2008 adult mortality test script
#libraries 
...
ir_data <- read_dta("/Users/matthewnicholson/DHS/Nigeria\ DHS\'s/NG_2008_DHS_04072025_2113_219655/NGIR53DT/NGIR53FL.DTA")
...
for (i in seq_along(varlist)) {
  ...
  ADMORT[[i]]  <- as.data.frame(simplified_admort_func(ir_data,Indicator=varlist[i]))
