...
NOTE: Some facilities are outside of SSIB borders but within the national borders and in the correct location.

SPAID = DHSCC&"SPA"&SPAYEAR&SPAFACID (with 8 digits) from survey documentation

DHSCC = 2 letter DHS country code (http://www.measuredhs.com/data/File-Types-and-Names.cfm)
